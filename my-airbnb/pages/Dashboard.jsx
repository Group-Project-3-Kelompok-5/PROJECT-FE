  ...
  return (
    ...
    <div>
        <div className='relative h-[300px] sm:h-[400px] lg:h-[500px] xl:h-[600px] 2xl:h-[700px] bg-blend-color-burn	bg-black '>
            <Image src='/BannerFIX.jpg' layout='fill' className='w-full object-fill brightness-50'/>
            <div className='absolute top-1/2 w-full text-center z-12'>
                <p className='text-white text-md md:text-xl xl:text-2xl mb-4'>Discover your next Travel</p>
                <button className='text-white bg-black px-10 py-4 rounded-full shadow-md font-bold hover:shadow-xl active:scale-90 transition duration-200'>Find a new Heaven</button>
            </div>
        </div>
    </div>
    <div className='w-full px-32 mx-auto px-5 bg-white'>
        <div className='pt-6'>
            <h2 className='text-3xl md:text-4xl text-black font-semibold pb-5'>Explore Nearby</h2>
        </div>
