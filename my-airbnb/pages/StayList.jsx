    ...
    <div className='bg-white h-screen'>
        ...
        <div className='flex px-3 py-2'>
            ...
            <div className='flex flex-col flex-grow pl-3'>
                <div>
                    <h4 className='text-black font-semibold '>Stay at this Spacious Apartment</h4>
                    <p className='text-black'>2 Bedroom, 1 Kitchen, 3 Bathroom, 1 Balcony, WiFi, Public Pool</p>
