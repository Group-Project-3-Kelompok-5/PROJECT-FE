        ...
        <div className='flex bg-white'>
            <div className='flex flex-col px-3 py-2 w-screen lg:w-[50%] h-full lg:px-5 rounded-xl'>
                ...
                <div className='relative h-24 w-40 md:h-52 md:w-80 flex-shrink-0'>
                    <Image src={'/Bedroom.png'} className='rounded-xl' layout='fill' objectFit='cover'/>
                </div>
                <div className='flex flex-col flex-grow pl-5'>
                    <div>
                        <h4 className='text-black font-semibold text-md '>Stay at this Spacious Apartment</h4>
                        <p className='text-black text-sm'>2 Bedroom, 1 Kitchen, 3 Bathroom, 1 Balcony, WiFi, Public Pool</p>
            ...
            <div className='hidden lg:inline-flex w-[50%] bg-white'>
                <Image src={'/Maps.png'} className='w-screen h-screen object-cover' width={100} height={100}/>
            </div>
        </div>
