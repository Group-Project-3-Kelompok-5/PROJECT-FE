            ...
            <div className="flex flex-col flex-grow pl-5">
              <div>
                ...
                />
                  ...
                  <button className='bg-black px-3 py-2 rounded-xl ml-5 cursor-pointer hover:shadow-xl active:bg-black transition transform duration-100 ease-out active:scale-95' onClick={getDetail}>Detail</button>
                </div>
              </div>
            </div>
          </div>
